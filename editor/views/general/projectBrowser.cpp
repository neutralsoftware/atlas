...
public:
    explicit ProjectRow(const AtlasProjectInfo& project,
        ...
        projectIcon->setPixmap(
            styling::icon(styling::Icon::GameController, "#6BA3FF")
                .pixmap(30, 30));
...
void ProjectBrowser::setupUi() {
    ...
    projectsNav->setIcon(
        styling::icon(styling::Icon::SquaresFour, "#6BA3FF"));
