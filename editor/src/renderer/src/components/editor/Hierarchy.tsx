...
const objectTypes: Record<string, ReactNode> = {
    ...
    pointLight: <AtomIcon className="h-3.5 w-3.5" />,
    pointlight: <AtomIcon className="h-3.5 w-3.5" />,
    spotLight: <AtomIcon className="h-3.5 w-3.5" />,
    spotlight: <AtomIcon className="h-3.5 w-3.5" />,
    directionalLight: <AtomIcon className="h-3.5 w-3.5" />,
    directionallight: <AtomIcon className="h-3.5 w-3.5" />,
    areaLight: <AtomIcon className="h-3.5 w-3.5" />,
    arealight: <AtomIcon className="h-3.5 w-3.5" />,
    ambientLight: <AtomIcon className="h-3.5 w-3.5" />,
    ambientlight: <AtomIcon className="h-3.5 w-3.5" />,
...
export default function Hierarchy() {
    ...
    return (
        <aside
            className="relative z-40 flex h-full w-full min-w-0 shrink-0 flex-col border-r border-slate-200 bg-white pt-10 text-slate-950 shadow-[16px_0_20px_rgba(15,23,42,0.25)] [clip-path:inset(0_-3rem_0_0)]"
